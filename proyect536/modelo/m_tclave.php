...
public function updateUserPass($user){
	$sql = "UPDATE tusuario_clave SET clave ='$this->clave',clave_anterior ='$this->clave_anterior' WHERE idusuario_clave = (SELECT idusuario_clave FROM tusuario WHERE usuario = '$user')";
	$this->ejecutar($sql);
}
