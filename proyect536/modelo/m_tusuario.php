...
/*FUNCION PARA REGISTRAR*/
	public function insertUser() {
		$sql = "INSERT INTO tusuario (idfuncionario,idusuario_clave,idusuario_preguntas,idusuario_perfil,departamento,usuario,inicio_sesion,primer_inicio,bloqueado,intentos_fallidos,fecha_creacion,fecha_final,hora_salida,fecha_salida,estatus) VALUES ('$this->idfuncionario','$this->idusuario_clave','$this->idusuario_preguntas','$this->idusuario_perfil','$this->departamento','$this->usuario','$this->inicio_sesion','$this->primer_inicio','$this->bloqueado','$this->intentos_fallidos','$this->fecha_creacion','$this->fecha_final','$this->hora_salida','$this->fecha_salida','$this->estatus')";
		$this->ejecutar($sql);
		$this->cerrar();
	}
/*===================================*/
...
/*FUNCION PARA CONSULTAR*/
	public function selectUser(){
		$sql = "SELECT f.cedula,u.usuario,c.clave,per.perfiles,per.idperfil_mayor,u.departamento, u.bloqueado,u.intentos_fallidos,u.primer_inicio
				FROM tusuario u
                INNER JOIN tfuncionario f ON f.idfuncionario = u.idfuncionario
