    ...
    <div class="col-sm-12 col-md-offset-3 col-md-6 col-xs-12" style="margin-top: 20%;">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
              <form action="../control/searchUser.php" method="POST" class="form-inline">
                ...
                <div class="form-group">
                  <button type="button"  id="searchUser" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Haga clic para buscar usuario"><i class="fas fa-search"></i> Buscar</button>
                </div>
                <div class="form-group">
