    ...
    <div class="col-sm-12 col-md-offset-3 col-md-6 col-xs-12" style="margin-top: 25%;">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
              <form action="" method="POST" id="form-people">
                <div class="form-group">
                  <div class="input-group">
                    <span class="input-group-addon"><i class="fas fa-unlock"></i></span>
                    <input type="text" id="pass" name="pass" class="form-control" placeholder="Nueva contraseña" data-toggle="popover" data-placement="left" data-trigger="focus" data-content="Minimo 8 caracteres, 1 letra minuscula, 1 numero, solo caracteres especiales.  ( _ / . * )">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
                    <span class="input-group-addon"><i class="fas fa-unlock"></i></span>
                    <input type="text" id="confpass" name="confpass" class="form-control" placeholder="Confirme contraseña" data-toggle="popover" data-placement="left" data-trigger="focus" data-content="Minimo 8 caracteres, 1 letra minuscula, 1 numero, solo caracteres especiales.  ( _ / . * )">
                  </div>
                </div>
                <div class="form-group">
                  <hr>
